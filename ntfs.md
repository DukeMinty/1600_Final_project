...
Aside from that, if you are someone who has multiple OS' and needs to transfer files between them, do not go with NTFS. Other file systems that will be discussed have better compatibility.
